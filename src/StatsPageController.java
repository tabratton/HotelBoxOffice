...
//    private Map<Integer, String[]> rating = new HashMap<Integer, String[]>();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            String sqlStatement = String.format("SELECT * FROM SEARCH_TERMS ORDER BY FREQUENCY DESC LIMIT 5");
            ...
            for (int i = 0; i < 5; i++){
                ...
                int avgRating = uniqueRating.getInt("total") / uniqueRating.getInt("number");
                switch (i){
                    case 1:
            ...
            for (int i = 0; i < 5; i++){
                ...
                switch (i){
                    case 1:
                        ViewedMovie1.setText(viewedActors.getString("ACTOR_NAME") + " (" + viewedActors.getInt("TIMES_VIEWED") + ")");
                        break;
                    case 2:
                        ViewedMovie2.setText(viewedActors.getString("ACTOR_NAME") + " (" + viewedActors.getInt("TIMES_VIEWED") + ")");
                        break;
                    case 3:
                        ViewedMovie3.setText(viewedActors.getString("ACTOR_NAME") + " (" + viewedActors.getInt("TIMES_VIEWED") + ")");
                        break;
                    case 4:
                        ViewedMovie4.setText(viewedActors.getString("ACTOR_NAME") + " (" + viewedActors.getInt("TIMES_VIEWED") + ")");
                        break;
                    case 5:
                        ViewedMovie5.setText(viewedActors.getString("ACTOR_NAME") + " (" + viewedActors.getInt("TIMES_VIEWED") + ")");
                        break;
                    default:
                        break;
                }
