...
CREATE TABLE `CASTING` (
  ...
  CONSTRAINT `CASTING_ACTOR_ID_fk` FOREIGN KEY (`ACTOR_ID`) REFERENCES `ACTORS` (`ACTOR_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `CASTING_MOVIES_MOIVE_ID_fk` FOREIGN KEY (`MOVIE_ID`) REFERENCES `MOVIES` (`MOVIE_ID`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `CUSTOMER` VALUES (1,'Vilma','abc123',12.99,'1001',1,'10501 FGCU Blvd S','Fort Myers','33965',''),(2,'Chad','abc123',14.99,'1002',1,'10501 FGCU Blvd S','Fort Myers','33965',''),(3,'Tyler','abc123',30.00,'1003',0,'10501 FGCU Blvd S','Fort Myers','33965','');
...
CREATE TABLE `CUSTOMER_RENTALS` (
  ...
  CONSTRAINT `CUSTOMER_RENTALS_CUSTOMER_CUSTOMER_ID_fk` FOREIGN KEY (`CUSTOMER_ID`) REFERENCES `CUSTOMER` (`CUSTOMER_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `CUSTOMER_RENTALS_MOVIES_MOIVE_ID_fk` FOREIGN KEY (`MOVIE_ID`) REFERENCES `MOVIES` (`MOVIE_ID`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `RATING` (
  ...
  CONSTRAINT `RATING_CUSTOMER_CUSTOMER_ID_fk` FOREIGN KEY (`CUSTOMER_ID`) REFERENCES `CUSTOMER` (`CUSTOMER_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `RATING_MOVIES_MOIVE_ID_fk` FOREIGN KEY (`MOVIE_ID`) REFERENCES `MOVIES` (`MOVIE_ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `SEARCH_TERMS` VALUES (1,'will',3),(2,'7',2),(3,'star wars',1),(4,'gump',1),(5,'morgan',2),(6,'men',1),(7,'l',1),(8,'j',1),(9,'mo',17),(21,'m',1),(27,'star',2),(30,'war',1),(32,'test',2),(33,'bob',4),(35,'smith',1);
...
-- Dump completed on 2016-11-27 20:09:38
